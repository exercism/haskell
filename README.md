...
You can refer to the [documentation on updating a test suite](https://github.com/exercism/docs/blob/master/language-tracks/exercises/anatomy/test-suites.md).
