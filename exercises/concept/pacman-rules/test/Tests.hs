...
main = hspec $ do
  describe "eatsGhost" $ do
    ...
    it "ghost not eaten when touched while un-powered" $ do
  ...
  describe "loses" $ do
    it "if touching a ghost while un-powered" $ do
      loses False True `shouldBe` True

    it "is False if touching a ghost while powered" $ do
      loses True True `shouldBe` False

    it "is False if not touching a ghost while powered" $ do
      loses True False `shouldBe` False

    it "is False if not touching a ghost while un-powered" $ do
      loses False False `shouldBe` False

  describe "wins" $ do
    it "if has eaten all dots and not touching a ghost while un-powered" $ do
      wins True False False `shouldBe` True

    it "if has eaten all dots and touching a ghost while powered" $ do
      wins True True True `shouldBe` True

    it "if has eaten all dots and not touching a ghost while powered" $ do
      wins True True False `shouldBe` True

    it "is False if has eaten all dots and touching a ghost while un-powered" $ do
      wins True False True `shouldBe` False

    it "is False if has not eaten all dots and not touching a ghost while un-powered" $ do
      wins False False False `shouldBe` False

    it "is False if has not eaten all dots and touching a ghost while powered" $ do
      wins False True True `shouldBe` False

    it "is False if has not eaten all dots and not touching a ghost while powered" $ do
      wins False True False `shouldBe` False

    it "is False if has not eaten all dots and touching a ghost while un-powered" $ do
