...
- Know that returning a tuple is a common for of multiple return in Haskell
- Know how to extract an element from a tuple using pattern matching
- Know how to perform a basic pattern match using the `=` function
...
- `type declartion`: needs to be able to define and use atoms for return values
